...
def mock_functions():
    with patch("controller.routes.get_content_for_methods") as mock_get_content, \
        ...
        mock_generate_facilitator_ppt.return_value = {"slides": [
            {"heading": "Slide 1", "script": "Speaker notes", "bullet_points": "Bullets"}]}
        mock_generate_knowledge_check.return_value = {"questions": [
            {"question": "What is AI?", "choices": ["A", "B", "C"], "answer": "A"}]}
        mock_regenerate_topic_outline.return_value = {"title": "Regenerated Topic",
                                                      "objectives": "Updated Objectives",
                                                      "citations": [{"id": "1", "title": "Citation",
                                                                     "chunks": "Chunk"}]}
        mock_shorten_notes.return_value = {"slides": [
            {"heading": "Slide 1", "script": "Shortened Speaker Notes"}], "script": "Shortened Speaker Notes"}
        ...
        mock_case_study.return_value = {
            "question": "Case Study Question", "choices": [
                "Option 1", "Option 2"], "answer": "Option 1"}
        mock_add_question.return_value = {"question": "New Question", "choices": ["X", "Y"], "answer": "X"}

        yield {
            "get_content": mock_get_content,
            "fetch_chunks": mock_fetch_chunks,
            "generate_topics": mock_generate_topics,
            "generate_speaker_notes": mock_generate_speaker_notes,
            "generate_facilitator_ppt": mock_generate_facilitator_ppt,
            "generate_knowledge_check": mock_generate_knowledge_check,
            "regenerate_topic_outline": mock_regenerate_topic_outline,
            "shorten_notes": mock_shorten_notes,
            "shorten_bullets": mock_shorten_bullets,
            "elaborate_notes": mock_elaborate_notes,
            "more_formal_notes": mock_more_formal_notes,
            "less_formal_notes": mock_less_formal_notes,
            "harder_multi": mock_harder_multi,
            "true_false": mock_true_false,
            "case_study": mock_case_study,
            "add_question": mock_add_question
        }
...
def test_router_generate_knowledge_check_500():
    ...
    with patch("controller.routes.generate_knowledge_check_for_facilitator_powerpoint") as mock_knowledge_check:
