...
scp -P 2222 gail-kong-web-sso-0.5.0.tar ssm-user@localhost:/home/ssm-user/
...
rsync -e "ssh -p 2222" -avz gail-kong-web-sso-0.5.0.tar ssm-user@localhost:/home/ssm-user/
