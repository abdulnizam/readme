Edit Component
    ✓ renders the Edit component with correct data (47 ms)
    ✓ handles button click correctly (15 ms)
  ...
  ● Edit Component › renders InsetText when regenerations are used
    ...
    Received: null
      ...
      152 |     render(<Edit />);
    > 153 |     expect(screen.queryByTestId('regenerations-used-inset-text')).toBeTruthy();
          |                                                                   ^
      154 |   });
      155 |
      156 |   test('handles AI reprompt click correctly', () => {

      at Object.toBeTruthy (app/[user-context]/edit/Edit.test.tsx:153:67)
  ...
  ● Edit Component › handles AI reprompt click correctly
    ...
    <body>
      ...
      156 |   test('handles AI reprompt click correctly', () => {
      157 |     render(<Edit />);
    > 158 |     fireEvent.click(screen.getByText('Use AI prompts'));
          |                            ^
      ...
      at Object.getByText (app/[user-context]/edit/Edit.test.tsx:158:28)

Test Suites: 1 failed, 1 total
Tests:       2 failed, 9 passed, 11 total
Snapshots:   0 total
Time:        1.676 s, estimated 9 s
