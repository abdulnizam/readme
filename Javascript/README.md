  Edit Component
    ...
    ✓ renders InsetText when regenerations are used (7 ms)
    ✕ handles AI reprompt click correctly (1034 ms)
    ✓ renders version navigation buttons correctly (12 ms)
  ...
  ● Edit Component › handles AI reprompt click correctly
    ...
    <body>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  Descriptor Title 1 topic 1 content Test Header
                  <br />
                </h4>
              </div>
              <div
      ...
      203 |     render(<Edit />);
      204 |   
    > 205 |     const aiButton = await waitFor(() => screen.getByTestId('use-ai-prompts-link'));
          |                                   ^
      206 |     fireEvent.click(aiButton);
      207 |   
      208 |     expect(mockFireRepromptContentStyle).toHaveBeenCalled();

      at waitForWrapper (node_modules/@testing-library/dom/dist/wait-for.js:163:27)
      at Object.<anonymous> (app/[user-context]/edit/Edit.test.tsx:205:35)

Test Suites: 1 failed, 1 total
Tests:       1 failed, 10 passed, 11 total
Snapshots:   0 total
Time:        2.68 s, estimated 3 s
