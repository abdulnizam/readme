 Edit Component
    ✓ renders the Edit component with correct data (62 ms)
    ✓ handles button click correctly (17 ms)
    ✓ handles regenerate content click correctly (7 ms)
    ✓ handles version selection correctly (7 ms)
    ✓ renders source materials correctly (5 ms)
    ✓ handles edit descriptor rendering correctly (6 ms)
    ✓ handles removing a question (7 ms)
    ✕ handles adding a question (9 ms)
    ✕ renders InsetText when regenerations are used (5 ms)
    ✕ handles AI reprompt click correctly (5 ms)
    ✓ renders version navigation buttons correctly (6 ms)

  ● Edit Component › handles adding a question

    TestingLibraryElementError: Unable to find an element by: [data-testid="generate-question-button"]
    ...
    <body>
      ...
      145 |   test('handles adding a question', () => {
      146 |     render(<Edit />);
    > 147 |     fireEvent.click(screen.getByTestId('generate-question-button'));
          |                            ^
      148 |     expect(mockAddNewEditContextItem).toHaveBeenCalled();
      149 |   });
      150 |
      ...
      at Object.getByTestId (app/[user-context]/edit/Edit.test.tsx:147:28)

  ● Edit Component › renders InsetText when regenerations are used

    TestingLibraryElementError: Unable to find an element by: [data-testid="regenerations-used-inset-text"]
    ...
    <body>
      ...
      151 |   test('renders InsetText when regenerations are used', () => {
      152 |     render(<Edit />);
    > 153 |     expect(screen.getByTestId('regenerations-used-inset-text')).toBeInTheDocument();
          |                   ^
      154 |   });
      155 |
      156 |   test('handles AI reprompt click correctly', () => {

      at Object.getElementError (node_modules/@testing-library/dom/dist/config.js:37:19)
      at node_modules/@testing-library/dom/dist/query-helpers.js:76:38
      at node_modules/@testing-library/dom/dist/query-helpers.js:52:17
      at node_modules/@testing-library/dom/dist/query-helpers.js:95:19
      at Object.getByTestId (app/[user-context]/edit/Edit.test.tsx:153:19)

  ● Edit Component › handles AI reprompt click correctly

    TestingLibraryElementError: Unable to find an element by: [data-testid="use-ai-prompts-link"]
    ...
    <body>
      ...
      156 |   test('handles AI reprompt click correctly', () => {
      157 |     render(<Edit />);
    > 158 |     fireEvent.click(screen.getByTestId('use-ai-prompts-link'));
          |                            ^
      159 |     expect(mockFireRepromptContentStyle).toHaveBeenCalled();
      160 |   });
      161 |
      ...
      at node_modules/@testing-library/dom/dist/query-helpers.js:52:17
      at node_modules/@testing-library/dom/dist/query-helpers.js:95:19
      at Object.getByTestId (app/[user-context]/edit/Edit.test.tsx:158:28)
